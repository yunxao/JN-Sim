...
public class Predicate {
   ...
   *  full predicate. */
  private ArrayList<AtomicPredicate> atoms;
  ...
  // ----- constructor Predicate(AtomicPredicate[]) ------------------------ //
  /**
   * Builds a predicate with the given atoms.
   */
  public Predicate(ArrayList<AtomicPredicate> atomlist) {
    atoms = atomlist;
  }
  ...
  public void add_atom(AtomicPredicate newatom) {
    if (atoms == null) {
      atoms = new ArrayList<AtomicPredicate>();
    }
    atoms.add(newatom);
  }
