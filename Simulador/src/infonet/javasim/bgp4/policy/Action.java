...
public class Action {
   ...
   *  in its entirety. */
  protected ArrayList<AtomicAction> atoms;
  ...
  // ----- constructor Action(boolean,AtomicAction[]) --------------------- //
  /**
   ...
   */
  public Action(boolean perm, ArrayList<AtomicAction> atomlist) {
    permit = perm;
  ...
  public void add_atom(AtomicAction newatom) {
    if (atoms == null) {
      atoms = new ArrayList<AtomicAction>();
    }
    atoms.add(newatom);
  }
