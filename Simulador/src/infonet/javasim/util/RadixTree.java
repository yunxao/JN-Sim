...
// ===== class infonet.javasim.util.RadixTree ==================== //
/**
 * This class is used as an efficient way to store information which
 * is keyed by a binary string (IP addresses, for example).
 */
