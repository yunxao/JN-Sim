...
// ===== class infonet.javasim.util ============================== //
/**
 * An iterator which traverses the nodes of a RadixTree.  For each
 * node which contains (non-null) data, it executes a user-supplied
 * function.
 */
