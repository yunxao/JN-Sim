...
public class BytesUtil
{
     ...
     *  messages. */
    public static int bytes_per_int = 2;    

    /** The maximum allowable integer value given the current number of bytes
     * per integer.
     *  @see #bytes_per_int */
    public static int max_int_val;
    ...
    // ----- Monitor.int2bytes(String,byte[]) ------------------------------ //
    /**
     * Converts an integer, given as a string, to bytes, returning the number
     * of bytes used.
     */
