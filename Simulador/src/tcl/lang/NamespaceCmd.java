...
public class NamespaceCmd implements InternalRep, Command {
	...
	if (cxtNs.resolver != null || interp.resolvers != null) {
		...
		if (cmd == null && interp.resolvers != null) {
		    Enumeration enume = interp.resolvers.elements();
		    while (cmd == null && enume.hasMoreElements()) {
			res = (Interp.ResolverScheme) enume.nextElement();
	...
	if (cxtNs.resolver != null || interp.resolvers != null) {
		...
		if (var == null && interp.resolvers != null) {
		    Enumeration enume = interp.resolvers.elements();
		    while (var == null && enume.hasMoreElements()) {
			res = (Interp.ResolverScheme) enume.nextElement();
